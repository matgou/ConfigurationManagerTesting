...
export class RuleTypeComponent implements OnInit, OnDestroy {
    ...
    trackId (index: number, item: RuleType) {
        return item.id;
    }
    ...
    registerChangeInRuleTypes() {
        this.eventSubscriber = this.eventManager.subscribe('ruleTypeListModification', (response) => this.reset());
    }
