...
import run.order66.application.domain.Authority;
import run.order66.application.domain.User;
import run.order66.application.repository.AuthorityRepository;
import run.order66.application.repository.UserRepository;
import run.order66.application.security.AuthoritiesConstants;
import run.order66.application.service.MailService;
import run.order66.application.service.UserService;
import run.order66.application.service.dto.UserDTO;
import run.order66.application.web.rest.vm.ManagedUserVM;
